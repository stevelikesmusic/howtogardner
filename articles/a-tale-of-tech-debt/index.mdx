...
<Figure
  caption={
    <>
      ...
      <Link
        className="underline"
        href="https://unsplash.com/@matthewhenry?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash"
      >
        Matthew Henry
      </Link>{' '}
      on{' '}
      <Link
        className="underline"
        href="https://unsplash.com/photos/man-sitting-on-chair-near-glass-window-MP4OSCYiGq0?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash"
      >
        Unsplash
      </Link>
    </>
