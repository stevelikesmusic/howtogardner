...
## When Technology Problems Become Collaboration Problems
...
Instead of trying to influence through authority or expertise, I focused on one question: _"How can I best help you?"_
...
Don't show up and ask teams to simply do work—ask questions and offer to help them solve problems. Create the first PR, gather the missing metrics, build the prototype. Show that you're willing to invest effort partnering alongside them.
...
The most sustainable influence comes from being of service: "I consistently take the time to be helpful, so let's work together to solve hard problems." Take the time to invest in building relationships and understand your partners.
